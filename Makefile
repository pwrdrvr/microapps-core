...
curl-deploy-version: ## Deploy a test version
	curl -v -H "Content-Type: application/json" https://apps.pwrdrvr.com/deployer/version/ \
		-d '{ "appName": "release", "semVer": "1.0.0", "s3SourceURI": "s3://pwrdrvr-apps-staging/release/1.0.0/", "lambdaARN": "arn:aws:lambda:us-east-2:239161478713:function:microapps-release:v1_0_0", "defaultFile": "foo.html" }'
