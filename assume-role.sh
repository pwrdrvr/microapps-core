...
aws sts assume-role --role-arn "arn:aws:iam::239161478713:role/AppNextJsDemoSvcs-svcServiceRoleCA147F4A-1G3MZZLL14EW0" --role-session-name secrets-cdk-session > $output
